...
$(document).ready(function() {
	$('.send3').click(function() {
			...
			$('.envok').html('<div id="for" class="for"> <div  style="z-index:1000;" class="window-container2 rrr window-container-visible2"><div style="z-index:1000;" class="sesions"><p style="color:#fff;" id="creacu">¡OFICINA PUBLICADA!<span class="close">X</span><div id="for" class="for" stylw="background-color:#fff;"></p><h2 style="width: 100%;font-size: 30px; color: #666; margin-left: 20%;">¡GRACIAS POR ELEGIRNOS!</h2> <p style="font-size: 25px; width: 100%; color: #666; margin: 2%; padding: 2%;" >Nos comunicaremos contigo para concretar tu visita en el espacio de trabajo que te gustó</p> <input value="ver oficina" style="width: auto; " name="subirimg" id="send" class="send" type="submit" style="margin: 10px 10px 10px 30%;" ></div></div></div>')
